...
entry3=Entry(fadf,textvariable=accountno,justify="right",bd=5,font=('arial',20,'bold'),bg="white",fg='black')
label4=Label(fadf,text="Username",font=('arial',20,'bold'))
entry4=Entry(fadf,textvariable=username1,justify="right",bg="white",bd=5,font=('arial',25,'bold'),fg='black')
label5=Label(fadf,text="fathername",font=('arial',20,'bold'))
entry5=Entry(fadf,textvariable=fathername,justify="right",bg="white",bd=5,font=('arial',25,'bold'),fg='black')
label6=Label(fadf,text="emailid",font=('arial',20,'bold'))
entry6=Entry(fadf,textvariable=emailid,bg="white",justify="right",bd=5,font=('arial',25,'bold'),fg='black')
label7=Label(fadf,text="gender",font=('arial',20,'bold'))
entry7=Entry(fadf,textvariable=gender,bg="white",justify="right",bd=5,font=('arial',25,'bold'),fg='black')
label8=Label(fadf,text="contactno",font=('arial',20,'bold'))
entry8=Entry(fadf,textvariable=contactno,bg="white",justify="right",bd=5,font=('arial',25,'bold'),fg='black')
labelia=Label(fadf,text="InitialAmount",font=('arial',20,'bold'))
entryia=Entry(fadf,textvariable=initialamount,justify="right",bg="white",bd=5,font=('arial',25,'bold'),fg='black')
...
entry9=Entry(fadw,textvariable=s1,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
label10=Label(fadw,text="Username",justify='left',font=('arial',20,'bold'))
entry10=Entry(fadw,textvariable=s2,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
label12=Label(fadw,text="initialamount",font=('arial',20,'bold'),justify='left')
entry12=Entry(fadw,textvariable=initial,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
label13=Label(fadw,text="withdraw money",font=('arial',20,'bold'),justify='left')
entry13=Entry(fadw,textvariable=withdraw,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
label14=Label(fadw,text="balance",font=('arial',20,'bold'),justify='left')
entry14=Entry(fadw,textvariable=balance,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
...
entry16=Entry(fade,textvariable=a1,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
label17=Label(fade,text="username",justify='left',font=('arial',20,'bold'))
entry17=Entry(fade,textvariable=a2,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
label19=Label(fade,text="current amount",font=('arial',20,'bold'),justify='left')
entry19=Entry(fade,textvariable=initialamount,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
label20=Label(fade,text="deposit money",font=('arial',20,'bold'),justify='left')
entry20=Entry(fade,textvariable=a5,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
label21=Label(fade,text="Balance",font=('arial',20,'bold'),justify='left')
entry21=Entry(fade,textvariable=balance,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
...
entry23=Entry(faee,textvariable=e1,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
label24=Label(faee,text="employeename",font=('arial',20,'bold'),justify='left')
entry24=Entry(faee,textvariable=e2,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
label25=Label(faee,text="fathername",font=('arial',20,'bold'),justify='left')
entry25=Entry(faee,textvariable=e3,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
label26=Label(faee,text="address",font=('arial',20,'bold'),justify='left')
entry26=Entry(faee,textvariable=e4,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
label27=Label(faee,text="emailid",font=('arial',20,'bold'),justify='left')
entry27=Entry(faee,textvariable=e5,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
label28=Label(faee,text="designation",font=('arial',20,'bold'),justify='left')
entry28=Entry(faee,textvariable=e6,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
label29=Label(faee,text="salary",font=('arial',20,'bold'),justify='left')
entry29=Entry(faee,textvariable=e7,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
labeld=Label(faee,text="date",font=('arial',20,'bold'),justify='left')
entryd=Entry(faee,textvariable=e8,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
labelg=Label(faee,text="gender",font=('arial',20,'bold'),justify='left')
entryg=Entry(faee,textvariable=e9,justify="right",bg="white",bd=5,font=('arial',30,'bold'))
...
entry30=Entry(facc1,textvariable=c1,justify="right",bg="sky blue",bd=5,font=('arial',30,'bold'))
label31=Label(facc1,text="emailid",font=('arial',20,'bold'),justify='left')
entry31=Entry(facc1,textvariable=c2,justify="right",bg="sky blue",bd=5,font=('arial',30,'bold'))
label32=Label(facc1,text="contactno",font=('arial',20,'bold'),justify='left')
entry32=Entry(facc1,textvariable=c3,justify="right",bg="sky blue",bd=5,font=('arial',30,'bold'))
label33=Label(facc1,text="complaint",font=('arial',20,'bold'),justify='left')
entry33=Entry(facc1,textvariable=c4,justify="right",bg="sky blue",bd=5,font=('arial',30,'bold'))
...
entry35=Entry(fads,textvariable=d1,justify="right",bg="sky blue",bd=5,font=('arial',30,'bold'))
label36=Label(fads,text="emailid",justify='left',font=('arial',20,'bold'))
entry36=Entry(fads,textvariable=d2,justify="right",bg="sky blue",bd=5,font=('arial',30,'bold'))
label37=Label(fads,text="contactno",font=('arial',20,'bold'))
entry37=Entry(fads,textvariable=d3,justify="right",bg="sky blue",bd=5,font=('arial',30,'bold'))
label38=Label(fads,text="suggesstion",font=('arial',20,'bold'))
entry38=Entry(fads,textvariable=d4,justify="right",bg="sky blue",bd=5,font=('arial',30,'bold'))
